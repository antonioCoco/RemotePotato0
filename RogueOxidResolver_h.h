...
#ifndef __ISpecialSystemPropertiesActivator_FWD_DEFINED__
#define __ISpecialSystemPropertiesActivator_FWD_DEFINED__
typedef interface ISpecialSystemPropertiesActivator ISpecialSystemPropertiesActivator;

#endif 	/* __ISpecialSystemPropertiesActivator_FWD_DEFINED__ */
...
EXTERN_C const IID IID_IStandardActivator;
    ...
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE StandardGetInstanceFromIStorage1( 
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
            /* [in] */ CLSCTX dwClsCtx,
            /* [in] */ IStorage *pstg,
            /* [in] */ int dwCount,
            /* [ref][out] */ MULTI_QI *pResults) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE StandardGetInstanceFromIStorage2( 
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
            /* [in] */ CLSCTX dwClsCtx,
        ...
        virtual HRESULT STDMETHODCALLTYPE StandardGetInstanceFromIStorage3( 
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
            /* [in] */ CLSCTX dwClsCtx,
    ...
    typedef struct IStandardActivatorVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *StandardGetInstanceFromIStorage1 )( 
            IStandardActivator * This,
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
            ...
            /* [in] */ IStorage *pstg,
            /* [in] */ int dwCount,
            /* [ref][out] */ MULTI_QI *pResults);
        
        HRESULT ( STDMETHODCALLTYPE *StandardGetInstanceFromIStorage2 )( 
            IStandardActivator * This,
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
        ...
        HRESULT ( STDMETHODCALLTYPE *StandardGetInstanceFromIStorage3 )( 
            IStandardActivator * This,
            /* [in] */ COSERVERINFO *pServerInfo,
            /* [in] */ REFCLSID pclsidOverride,
            /* [in] */ IUnknown *punkOuter,
...
#define IStandardActivator_StandardGetInstanceFromIStorage1(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults)	\
    ( (This)->lpVtbl -> StandardGetInstanceFromIStorage1(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults) ) 

#define IStandardActivator_StandardGetInstanceFromIStorage2(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults)	\
    ( (This)->lpVtbl -> StandardGetInstanceFromIStorage2(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults) ) 

#define IStandardActivator_StandardGetInstanceFromIStorage3(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults)	\
    ( (This)->lpVtbl -> StandardGetInstanceFromIStorage3(This,pServerInfo,pclsidOverride,punkOuter,dwClsCtx,pstg,dwCount,pResults) ) 
...
#ifndef __ISpecialSystemPropertiesActivator_INTERFACE_DEFINED__
#define __ISpecialSystemPropertiesActivator_INTERFACE_DEFINED__

/* interface ISpecialSystemPropertiesActivator */
/* [uuid][object] */ 


EXTERN_C const IID IID_ISpecialSystemPropertiesActivator;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("000001B9-0000-0000-c000-000000000046")
    ISpecialSystemPropertiesActivator : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE SetSessionId( 
            /* [in] */ int dwSessionId,
            /* [in] */ int bUseConsole,
            /* [in] */ int fRemoteThisSessionId) = 0;
    ...
    typedef struct ISpecialSystemPropertiesActivatorVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ISpecialSystemPropertiesActivator * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *SetSessionId )( 
            ...
            /* [in] */ int dwSessionId,
            /* [in] */ int bUseConsole,
            /* [in] */ int fRemoteThisSessionId);
        
        END_INTERFACE
    } ISpecialSystemPropertiesActivatorVtbl;

    interface ISpecialSystemPropertiesActivator
    {
        CONST_VTBL struct ISpecialSystemPropertiesActivatorVtbl *lpVtbl;
    };
...
#define ISpecialSystemPropertiesActivator_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ISpecialSystemPropertiesActivator_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ISpecialSystemPropertiesActivator_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ISpecialSystemPropertiesActivator_SetSessionId(This,dwSessionId,bUseConsole,fRemoteThisSessionId)	\
...
#endif 	/* __ISpecialSystemPropertiesActivator_INTERFACE_DEFINED__ */
